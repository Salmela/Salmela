...
- **[Pelix](https://salmela.dev/demoes/pelix/)**: Parser, interpreter and debugger for little toy language that I did in the middle of lapland without any tools.
  - I used [existing parsing library](https://github.com/dmaevsky/rd-parse), but I ended up rewriting it as it's parsing algorithm was too slow
